...
Na Figura \ref{fig:quantidades}, (A) ilustra o gráfico para a implementação convencional em CPU, (B) ilustra o gráfico para a implementação convencional em GPU, (C) ilustra o gráfico para a implementação \textit{bitstring} em CPU e (D) ilustra o gráfico para a implementação \textit{bitstring} em GPU.
