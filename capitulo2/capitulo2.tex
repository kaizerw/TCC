...
Especificamente neste trabalho, o enfoque é no uso da abordagem de sistemas multiagente à modelagem e implementação do modelo SEIRS descrito anteriormente. Na Seção \ref{sec:agentesinteligentes} são apresentados e discutidos em detalhes as características e classificações de agentes e ambientes em que podem estar inseridos, assim como outros conceitos importantes ao tema. 
