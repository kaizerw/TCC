...
\begin{itemize}
  ...
  \begin{multicols}{2}
    \begin{equation*}
      \begin{cases}
	\frac{d\big(S(t)\big)}{dt} = - \frac{\beta}{N} \, I(t) \, S(t) + \delta \, R(t) \\
	S(0) = S_{0} \\
	\frac{d\big(E(t)\big)}{dt} = + \frac{\beta}{N} \, I(t) \, S(t) - \gamma \, E(t) \\
	E(0) = E_{0} \\
	\frac{d\big(I(t)\big)}{dt} = + \gamma \, E(t) - \alpha \, I(t) \\
	I(0) = I_{0} \\
	\frac{d\big(R(t)\big)}{dt} = + \alpha \, I(t) - \delta \, R(t) \\
	R(0) = R_{0} \\
      \end{cases}
    \end{equation*}
