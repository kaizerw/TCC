...
Na modelagem realizada, as especificações às quantidades são $Pl = 0$, $Px = 6$, $Py = 15$, $Pc = 24$, $Pe = 30$, $C\#l = 26$, $C\#x = 23$, $C\#y = 23$, $C\#c = 26$ e $C\#e = 30$, de modo que \ref{eq:bitstring_get} é então reescrita para os ciclos $t$ e $t+1$ designados como \textit{old} e \textit{new}, respectivamente, como em \ref{eq:bitstring_get_2}.
\begin{equation}
  \begin{cases}
